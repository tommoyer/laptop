...
then
        ...
        echo ""
        pamu2fcfg | tee -a u2f_mappings   # Backup YubiKey
        ...
        echo ""
        pamu2fcfg -n | tee -a u2f_mappings               # Main YubiKey
